...
class MonitorManager():
    ...
    def __init__(self, resource, target, payload):
        """
            It initializes the class variables, loads the default
            parameters and fills the method running dictionary.
        """
    ...
    def _check_assertion(self):
        """
            It checks if the resource and target are included
    ...
    def __put(self):
        ...
        if not self.payload:
            abort(400)
        command = 'python apis/monitor/monitor_start.py start %s %s %s' % (self.payload['time'], self.target, self.resource)
        os.system(command)
    ...
    def run(self, method):
        """
            The starting point of the class. It runs the
            specific python method according to the
            ...
            Returns:
                the HTTP response generated by the python 
                methods.
        """
